...
HF_MODEL_PRESETS = {
    "prompt_injection": {
        "protectai_deberta_v3_small_v2": "protectai/deberta-v3-small-prompt-injection-v2",
        "protectai_deberta_v2": "protectai/deberta-v3-base-prompt-injection-v2",  # keep as fallback
    },
    "moderation": {
    ...
    "zero_shot": {
        "minilm_l6_nli": "cross-encoder/nli-MiniLM2-L6-H768"
    },
    "semantic_relevance": {
