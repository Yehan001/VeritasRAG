...
st.caption("Safe + from KB → PASSED | Safe + outside KB → PASSED_WITH_WARNING | Harmful → BLOCKED")
...
st.info("Pipeline: input rails → PII masking → prompt attack model → moderation/zero-shot safety model → KB relevance/grounding → policy decision engine. This follows common guardrail gateway patterns used in open-source guardrail frameworks and research systems.")
